...
def main() :
    ...
    # information = [[['bread', '갈릭 브레드', 6, "app"], ['pasta', '갈릭 까르보나라', 12, "mai"], ['pizza', '부처스 피자', 14, "mai"],
    #                 ['dessert', '아포카토', 5, 'des']],
    #
    #                [['박성호', 'bread', 2,
    #                  [["1", "1_1", "bread", ["갈릭 브레드", 12], "app"], ["1", "1_1", "bread", ["갈릭 브레드", 12], "app"]],
    #                  "None", "None"],
    #                 ['정성운', 'pasta', 2, [["1", "1_1", "pasta", ["갈릭 까르보나라", 12], "app"]], "None", "None"],
    #                 ['이상민', 'pizza', 2, [["1", "1_2", "pizza", ["부처스 피자", 12], "mai"]], "None", "None"],
    #                 ['백종원', 'dessert', 1, ["None"], "None", "None"]],
    #
